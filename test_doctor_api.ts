...
async function testApi() {
    ...
    try {
        ...
        const loginRes = await axios.post('https://ev-clinic.kiaantechnology.com/app/api/auth/login', { email, password });
        ...
        const templatesRes = await axios.get('https://ev-clinic.kiaantechnology.com/app/api/doctor/templates', {
            headers: {
