...
async function testFetch() {
    const LOGIN_URL = 'https://ev-clinic.kiaantechnology.com/app/api/auth/login';
    const TEMPLATES_URL = 'https://ev-clinic.kiaantechnology.com/app/api/doctor/templates';
